...
const UserAccountLayout = ({ children }) => {
  const { user, token, clearUser } = useAuth();
    ...
    <div>
      ...
      <div className="btn-sidebar-account">
        <Sheet>
          ...
          <SheetContent side="left" className="w-[90%] px-2">
            <header className="canvas-header" style={{ top: "unset" }}>
              <span className="text-btn-uppercase">SIDEBAR ACCOUNT</span>
            </header>
            <div className="canvas-body p-0 sidebar-mobile-append">
              <div className="sidebar-account">
                <div className="account-avatar mt-20">
                  <div className="image">
                ...
                <ul className="my-account-nav">
                  ...
                  <li>
                    <span
                      ...
                      className="my-account-nav-item bg-danger text-white"
                    >
                      <svg
                        width={24}
                        height={24}
