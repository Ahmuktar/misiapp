...
(function ($) {
            ...
            success: function (msg) {
              ...
              $form.prepend(
                $("<div />", {
                  ...
                  $(
                    '<a className="close" href="#"><i className="icon icon-close2"></i></a>'
                  )
                )
              );
  ...
  var ajaxSubscribe = {
    obj: {
      ...
      success_message:
        '<div className="notification_ok text-success">Thank you for joining our mailing list!</div>',
      failure_message:
        '<div className="notification_error text-critical">Error! <strong>There was a problem processing your submission.</strong></div>',
  ...
  var RTL = function () {
    if (localStorage.getItem("dir") === "rtl") {
      ...
      $("#toggle-rtl").text("ltr");
      $(
        ".tf-slideshow .tf-btn,.view-all-demo .tf-btn, .pagination-link, .pagination-item, .tf-breadcrumb-list,.tf-list-categories.style-1"
      )
        .find(".icon-arrRight")
