...
const CartItem = ({ cart, handleRemoveItem }) => {
  return (
                ...
                <div className="list-cart">
                  ...
                  <div className="list-cart-item">
                    <div className="image">
                      <img
                        className=" ls-is-cached lazyloaded"
                        data-src="/assets/images/products/womens/women-5.jpg"
                        src="/assets/images/products/womens/women-5.jpg"
                        alt=""
                      />
                    </div>
                    <div className="content">
                  ...
                  <div className="list-cart-item">
                    <div className="image">
                      <img
                        className="lazyload"
                        data-src="/assets/images/products/womens/women-6.jpg"
                        src="/assets/images/products/womens/women-6.jpg"
                        alt=""
                      />
                    </div>
                    <div className="content">
                    ...
                    <div className="tf-mini-cart-bottom-wrap">
                      ...
                      <div className="tf-mini-cart-view-checkout">
                        ...
                        <Link
                          ...
                          onClick={(e) => !isTermsChecked && e.preventDefault()}
                        >
                    ...
                    <div className="tf-mini-cart-tool-content">
                      ...
                      <form className="form-add-note tf-mini-cart-tool-wrap">
                        ...
                        <div className="tf-cart-tool-btns">
                          ...
                          <div className="text-center w-100 text-btn-uppercase tf-mini-cart-tool-close">
                            Cancel
                          </div>
                        </div>
                      </form>
